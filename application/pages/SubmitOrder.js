  ...
  saveData() {
    if (this.props.policyid != undefined) {
      realm.saveData('StartPolicy', {
        articaltype: this.props.articalType,
  ...
  render() {
    return (
      <View style={Form.Container}>
          ...
          <View>
            {this.props.declare ? <View style={{margin:15}}><Text style={{color:'#ec082e'}}>拟申报政策:{this.props.policy}</Text></View>:null}
          </View>  
          ...
          <Button title='提交申报预约' buttonStyle={styles.buttonStyle} onPress={
            this.submiteForm
          }/>
          <Nav selected="2"/>
        </View>
